...
/* ═══ DATA ═══ */
const UX_GAPS = [
  { rank:1, title:"Hidden total cost until checkout", severity:"Critical", phase:"Pre-Purchase → Bidding", stepId:"learn_bidding", evidence:"15% buyer premium + $2 lot fee invisible during bidding. Proxibid BBB: hidden fees #1 pain. MoneyAt30 warns to factor fees.", uxFix:"Show total cost (bid + premium + fee) next to bid button before bid is placed.", bizFix:null, impact:"eBay's upfront cost display is industry standard. Reduces BBB complaints." },
  ...
  { rank:5, title:"Pickup rules overwhelm", severity:"High", phase:"Pre-Purchase → Winning", stepId:"understand_pickup", evidence:"10+ scheduling rules hidden from user: appointment vs live vs mixed days, 1 active appointment limit, 2-day booking window, order selection changes calendar, partial pickup must start from oldest, multi-location needs separate appointments, variable daily slot availability, cutoff rules by order size, no-show penalties.", uxFix:"Visual decision tree. One-page booking wizard.", bizFix:null, impact:"Lowest feeling score (-1.5) in entire journey. Highest cognitive load step." },
